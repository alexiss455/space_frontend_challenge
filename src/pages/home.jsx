...
bg-cover flex items-center justify-center absolute top-0 bg-slate-900 max-md:pb-8`}
    >
      <div className="grid md:grid-cols-2 max-w-5xl gap-y-8 mx-auto gap-x-32 max-lg:px-8 mt-28">
        ...
        <div
          className="relative text-[2rem] font-sans w-64 h-64 bg-white text-black flex items-center justify-center rounded-full m-auto after:content-['']  after:w-64 after:h-64 after:bg-white after:opacity-25 after:rounded-full after:absolute after:hover:scale-150 after:duration-700 cursor-pointer
          "
        >
          <h1>EXPLORE</h1>
        </div>
